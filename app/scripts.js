...
(function() {
	...
	class MMOOSM {
		...
		injectCSS() {
			...
			{ class: `country-selector + .${this.handle}_input`, val: `border-left: 0; border-bottom-left-radius: 0px; border-top-left-radius: 0px;` },
			...
			{ class: `country-selector_selected .${this.handle}_country-selector_list_option`, val: `background: none!important;` },
			{ class: `country-selector_selected .${this.handle}_country-selector_list_option span`, val: `width:auto;width:initial;` },
			{ class: `country-selector_selected .${this.handle}_country-selector_list_option img`, val: `width: 16px; min-width: 16px; margin-bottom: -1px` },
			...
			{ class: `country-selector:hover .${this.handle}_country-selector_list`, val: `display: block;` },
			...
			{ class: `disabled .${this.handle}_field`, val: 'opacity: .3; pointer-events: none;'},
			{ class: `disabled .${this.handle}_action_submit`, val: 'opacity: .3; pointer-events: none;'},
			{ class: `loading .${this.handle}_action_submit`, val: `position: relative; ${this.css('color:', 'submit_bg_color')}` },
			{ class: `loading .${this.handle}_action_submit::after`, val: `content: ""; position: absolute; top: 50%; left: 50%; width: 20px; height: 20px; margin: -10px 0 0 -10px; border-radius: 50%; ${this.css('border: 5px solid', 'submit_color')} border-top-color: transparent; border-right-color: transparent; -webkit-animation:${this.handle}-rotate .6s linear infinite;animation:${this.handle}-rotate .6s linear infinite` },
			];
			var css = '';
